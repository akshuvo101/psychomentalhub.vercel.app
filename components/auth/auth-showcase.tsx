...
export default function AuthShowcase() {
  return (
    <aside
      aria-label="AI wellness platform overview"
      className="relative hidden min-h-screen overflow-hidden lg:flex lg:w-[52%] xl:w-[55%]"
    >
      {/* Background */}
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-linear-to-br from-emerald-600 via-teal-600 to-cyan-700"
      />

      {/* Ambient Glow */}
      <div
        aria-hidden="true"
        className="absolute -left-32 -top-32 h-96 w-96 rounded-full bg-cyan-300/20 blur-[100px]"
      />

      <div
        aria-hidden="true"
        className="absolute -bottom-40 -right-20 h-[500px] w-[500px] rounded-full bg-emerald-300/20 blur-[120px]"
      />

      <div
        aria-hidden="true"
        className="absolute left-1/2 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/10 blur-[100px]"
      />

      {/* Subtle Grid */}
      <div
        aria-hidden="true"
        className="absolute inset-0 opacity-[0.07] [background-image:linear-gradient(rgba(255,255,255,1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,1)_1px,transparent_1px)] [background-size:48px_48px]"
      />
        ...
        <div className="max-w-xl">
          ...
          >
            ...
            <p className="mt-5 max-w-md text-sm leading-6 text-white/75 xl:text-base">
              Understand your mental wellness, build
              healthier habits, and get personalized
